...
function Achievments() {
  return (
    <div className=" w-full py-16 bg-green-50 px-2 ">
      <div className=" flex max-w-7xl justify-between items-center mx-auto">
        <div>
          <p className=" text-4xl text-gray-700 font-bold py-1">
            Helping a local <br />
        ...
        <div className=" grid grid-cols-2 gap-14 ">
          <div className=" flex justify-center items-center gap-4">
            ...
            <div>
              <p className=" text-3xl py-1 font-bold text-gray-800 ">
                2,245,341
              </p>
              <p className=" text-xl  text-gray-600 font-normal py-1 ">
                Members
              </p>
            </div>
          </div>
          <div className=" flex justify-center items-center gap-4">
            ...
            <div>
              <p className=" text-3xl py-1 font-bold text-gray-800 ">46,328</p>
              <p className=" text-xl  text-gray-600 font-normal py-1 ">Clubs</p>
            </div>
          </div>
          <div className=" flex justify-center items-center gap-4">
            <div>
            ...
            <div>
              <p className=" text-3xl py-1 font-bold text-gray-800 ">828,867</p>
              <p className=" text-xl  text-gray-600 font-normal py-1 ">
                Event Bookings
              </p>
            </div>
